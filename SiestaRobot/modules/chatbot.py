...
import html
import requests
import ZhuRobot.modules.sql.chatbot_sql as sql
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "𝗞𝗮𝗴𝘂𝗿𝗮 𝗥𝗼𝗯𝗼𝘁 Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get('https://www.kukiapi.xyz/api/apikey=KUKIg76Fg4EIo/ZhuXRobot/@TripleNineee/message='+Message)
